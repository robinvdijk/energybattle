...
(function() {
  $(function() {
    $('.fa-bell').click(function(event) {
      event.preventDefault();
      return $('.notifications-center').toggleClass('active');
    });
    $('.flash').click(function(e) {
      return this.remove();
    });
    return $('#progressbar li').each(function() {
...
// $(document).ready(function() {
//   if(window.location.hash=="#_=_") window.location.href="http://localhost:3000";
// });
$(document).ready(function() {
